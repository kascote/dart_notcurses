...
void unicodeDumper(NotCurses nc, Plane plane, List<String> indent) {
  ...
  final int ur = Channels.initializer(0xff, 0xff, 0xff, 0x1B, 0xd8, 0x8E);
  final int lr = Channels.initializer(0xff, 0xff, 0xff, 0xdB, 0x18, 0x8E);
  final int ul = Channels.initializer(0xff, 0xff, 0xff, 0x19, 0x19, 0x70);
  final int ll = Channels.initializer(0xff, 0xff, 0xff, 0x19, 0x19, 0x70);
